...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 4 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 4 },
	[4]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 4 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(2),   975000 },
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(8),  1125000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(10), 1125000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(12), 1175000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(2),   925000 },
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(8),  1075000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(10), 1075000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(12), 1125000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(2),   875000 },
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(8),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(10), 1025000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(12), 1075000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(8),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(10), 1000000 },
	{ 0, {  1080000, HFPLL, 1, 0x28 }, L2(12), 1050000 },
